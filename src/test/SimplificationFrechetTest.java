...
import visualization.FrechetDistanceDemo2D;
...
public class SimplificationFrechetTest
{
    ...
    public static void main(String[] args) {
        ...
        for (int i = 0 ; i < 300 ; i++){
            ...
            Coordinates q_start = q.getCoordinates().get(0);
            Coordinates q_end = q.getCoordinates().get(q.getCoordinates().size() - 1);

            trmap.entrySet().forEach(e->{
                Trajectory C = e.getValue();
                Coordinates c_start = C.getCoordinates().get(0);

                Coordinates c_end = C.getCoordinates().get(C.getCoordinates().size() - 1);
...
//                                FrechetDistanceDemo2D.vis(trajectories1);
    ...
    private static List<Coordinates> getCoordList(String s) {
